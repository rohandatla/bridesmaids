      ...
      <div className="container mx-auto px-4 max-w-2xl text-center">
        <FadeInWhenVisible>
          ...
          <p className="text-white/70 mb-10">
            Let {BRIDESMAID_DATA.bride} know.
          </p>
        </FadeInWhenVisible>
        ...
        <AnimatePresence mode="wait">
          ...
          {choice === "yes" && status !== "submitted" && (
            ...
            >
              ...
              <p className="text-gray-600 text-center text-sm mb-6">
                Drop your latest mailing address so {BRIDESMAID_DATA.bride} can send you a bridesmaid gift.
              </p>
          ...
          {choice === "yes" && status === "submitted" && (
            ...
            >
              ...
              <p className="text-xl text-white font-serif">
                You&apos;re locked in, {guestName}. {BRIDESMAID_DATA.bride} has your address for the gift — more details coming soon.
              </p>
            </motion.div>
          )}
          ...
          {choice === "no" && status === "submitted" && (
            ...
            >
              <p className="text-xl text-white font-serif">
                No worries at all, {guestName} — reach out to {BRIDESMAID_DATA.bride} whenever you can talk it through.
              </p>
            </motion.div>
          )}
        </AnimatePresence>
