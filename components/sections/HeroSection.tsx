  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-6 max-w-3xl mx-auto">
        ...
        >
          {BRIDESMAID_DATA.bride} is getting married
        </motion.p>
        ...
        >
          {BRIDESMAID_DATA.ask.subheading}
        </motion.p>
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <CountdownTimer targetDate={BRIDESMAID_DATA.wedding.dateIso} />
        </motion.div>
